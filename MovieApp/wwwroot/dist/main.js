...
let UpdateCommentComponent = class UpdateCommentComponent {
    constructor(http, baseUrl, route, formBuilder, router) {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            ...
            important: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
        ...
        http.get(baseUrl + 'api/Comments/' + this.id).subscribe(result => {
            ...
            this.form = this.formBuilder.group({
                id: this.id,
                text: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.comment.text),
                important: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.comment.important),
                movieItemId: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.comment.movieItemId)
            });
            console.log(this.comment);
        }, error => console.error(error));
    }
...
let UpdateMovieComponent = class UpdateMovieComponent {
    constructor(http, baseUrl, route, formBuilder, router) {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            ...
            addedDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](''),
            rating: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](''),
            watched: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('')
        });
        ...
        http.get(baseUrl + 'api/MovieItems/' + this.id).subscribe(result => {
            ...
            this.form = this.formBuilder.group({
                id: this.id,
                title: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.title),
                description: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.description),
                genre: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.genre),
                duration: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.duration),
                releaseYear: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.releaseYear),
                director: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.director),
                addedDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.addedDate),
                rating: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.rating),
                watched: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.movie.watched)
            });
            console.log(this.movie);
        }, error => console.error(error));
    }
